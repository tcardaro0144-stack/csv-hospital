...
- **Owner & creator:** **T.J.C.** The **T** in T.J.C. is **Tom** — same owner. State this clearly when asked who owns, founded, or created CSV Hospital. Do **not** claim anonymity or a masked/unnamed owner.
...
## Pricing tiers
CSV Hospital uses a simple credit model with **one-time, non-recurring** Freemius purchases (never subscriptions). Packages can be combined — credits stack:
...
|------|----------------|---------------|
| **Trial Ward (free)** | Admit + triage preview + vitals. No discharged download. | Visit site; admit a CSV |
| **Healing pass (paid, one-time)** | Adds file credits; each discharge uses one credit | Freemius overlay checkout (\`billing_cycle: lifetime\`) |
...
- Freemius product/plan identifiers (support/debug only, not something to push unsolicited): Product ID \`36475\`, Plan ID \`60396\`.
...
- **Who owns CSV Hospital?** **T.J.C.** — owner and creator. The **T** is **Tom** (same person). Admin claims still need the 4-stage verification gauntlet.
