/**
 * Always-on Gateway resilience for the Faceless Discord bot.
...
export function installDiscordProcessGuards(opts = {}) {
  ...
  if (globalThis.__facelessDiscordGuardsInstalled) {
    return
  }
  globalThis.__facelessDiscordGuardsInstalled = true
